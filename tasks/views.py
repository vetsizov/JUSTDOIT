...
a = dt.now().hour + 3
if a >= 6 and a <= 11:
    vremya_s = 'Кстати, какой там у нас сейчас час по Москве? - ' + str(a) + '. Доброе утро! Пей кофе и принимайся за дела!'
    fcolor = 'IndianRed'
elif a >= 12 and a <= 17:
    vremya_s = 'Кстати, какой там у нас сейчас час по Москве? - ' + str(a) + '. Добрый день! Самое время сделать все дела!'
    fcolor = 'SpringGreen'
elif a >= 18 and a <= 24:
    vremya_s = 'Кстати, какой там у нас сейчас час по Москве? - ' + str(a) + '. Добрый вечер! Не ложись спать пока не выполнишь все дела!'
    fcolor = 'MediumAquamarine'
else:
    vremya_s = 'Кстати, какой там у нас сейчас час по Москве? - ' + str(a) + '. Доброй ночи! Спать некогда, делай дела!'
